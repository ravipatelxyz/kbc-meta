...
def main(argv):
    ...
    parser = argparse.ArgumentParser('Knowledge Graph Splitter', formatter_class=formatter)

    parser.add_argument('triples', type=str, default='/dev/stdin', help='Path of the file containing the KG triples')

    parser.add_argument('--train', required=True, type=argparse.FileType('w'), default='/dev/stdout',
                           help='Path of the training set')

    parser.add_argument('--valid', required=True, type=argparse.FileType('w'), default='/dev/stdout',
                           help='Path of the validation set')
    parser.add_argument('--valid-size', required=True, action='store', type=int, default=1000,
                           help='Size of the validation set')

    parser.add_argument('--test', required=True, type=argparse.FileType('w'), default='/dev/stdout',
                           help='Path of the test set')
    parser.add_argument('--test-size', required=True, action='store', type=int, default=1000,
                           help='Size of the test set')

    parser.add_argument('--seed', action='store', type=int, default=0, help='Seed for the PRNG')
