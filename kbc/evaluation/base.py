...
from kbc.models import BasePredictor
...
def evaluate(entity_embeddings: nn.Embedding,
    ...
    # sp_to_o is a dictionary with each key a given pair of subject and predicate,
    #   and each value a list of all objects tripled with that sp pair in the dataset
    # po_to_s is a dictionary with each key a given pair of object and predicate,
    #   and each value a list of all subjects tripled with that po pair in the dataset
    sp_to_o, po_to_s = {}, {}
